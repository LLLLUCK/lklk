...
<div>
    <a href="${pageContext.request.contextPath}/user/load.do/8.jpg">
        <img src="${pageContext.request.contextPath}/images/8.jpg" width="300px"></a>

    <a href="${pageContext.request.contextPath}/user/load.do/9.jpg">
        <img src="${pageContext.request.contextPath}/images/9.jpg" width="300px"></a>

    <a href="${pageContext.request.contextPath}/user/load.do/10.jpg">
        <img src="${pageContext.request.contextPath}/images/10.jpg" width="300px"></a>

    < <a href="${pageContext.request.contextPath}/user/load.do/11.jpg">
    <img src="${pageContext.request.contextPath}/images/11.jpg" width="300px"></a>
</div>
</body>
</html>
